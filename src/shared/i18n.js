...
const MESSAGES = {
    es: {
        ...
        labelGameBlocksEnabled: 'Toggles por juego',
        hintGameBlocksEnabled: 'Muestra un botón para colapsar o expandir cada bloque de juego en el pedido',
        labelGameBlocksCollapsed: 'Colapsado por defecto',
        labelGameBlocksSubtotalEnabled: 'Desglose por juego',
        hintGameBlocksSubtotalEnabled: 'Muestra el subtotal de cada juego en el resumen del pedido',
        h1About:           'Acerca de',
    ...
    en: {
        ...
        labelGameBlocksEnabled: 'Per-game toggles',
        hintGameBlocksEnabled: 'Shows a button to collapse or expand each game block in the order',
        labelGameBlocksCollapsed: 'Collapsed by default',
        labelGameBlocksSubtotalEnabled: 'Per-game breakdown',
        hintGameBlocksSubtotalEnabled: 'Shows the subtotal for each game in the order summary',
        h1About:           'About',
    ...
    fr: {
        ...
        labelGameBlocksEnabled: 'Boutons par jeu',
        hintGameBlocksEnabled: 'Affiche un bouton pour réduire ou développer chaque bloc de jeu dans la commande',
        labelGameBlocksCollapsed: 'Réduit par défaut',
        labelGameBlocksSubtotalEnabled: 'Détail par jeu',
        hintGameBlocksSubtotalEnabled: 'Affiche le sous-total de chaque jeu dans le résumé de la commande',
        h1About:           'À propos',
    ...
    de: {
        ...
        labelGameBlocksEnabled: 'Schaltflächen pro Spiel',
        hintGameBlocksEnabled: 'Zeigt eine Schaltfläche zum Ein-/Ausklappen jedes Spielblocks in der Bestellung',
        labelGameBlocksCollapsed: 'Standardmäßig eingeklappt',
        labelGameBlocksSubtotalEnabled: 'Aufschlüsselung pro Spiel',
        hintGameBlocksSubtotalEnabled: 'Zeigt den Teilbetrag jedes Spiels in der Bestellübersicht',
        h1About:           'Über',
    ...
    it: {
        ...
        labelGameBlocksEnabled: 'Toggle per gioco',
        hintGameBlocksEnabled: 'Mostra un pulsante per comprimere o espandere ogni blocco di gioco nell\'ordine',
        labelGameBlocksCollapsed: 'Compresso per impostazione predefinita',
        labelGameBlocksSubtotalEnabled: 'Dettaglio per gioco',
        hintGameBlocksSubtotalEnabled: 'Mostra il subtotale di ogni gioco nel riepilogo dell\'ordine',
