...
const MESSAGES = {
    es: {
        ...
        labelGameSwitcherFullContextEnabled: 'Preservar página y filtros',
        hintGameSwitcherFullContextEnabled: 'Mantiene también la subpágina actual y los filtros genéricos (ej. ordenación) al cambiar de juego',
        h1About:           'Acerca de',
    ...
    en: {
        ...
        labelGameSwitcherFullContextEnabled: 'Preserve page and filters',
        hintGameSwitcherFullContextEnabled: 'Also keeps the current subpage and generic filters (e.g. sort order) when switching games',
        h1About:           'About',
    ...
    fr: {
        ...
        labelGameSwitcherFullContextEnabled: 'Conserver la page et les filtres',
        hintGameSwitcherFullContextEnabled: 'Conserve également la sous-page actuelle et les filtres génériques (ex. tri) lors du changement de jeu',
        h1About:           'À propos',
    ...
    de: {
        ...
        labelGameSwitcherFullContextEnabled: 'Seite und Filter beibehalten',
        hintGameSwitcherFullContextEnabled: 'Behält beim Spielwechsel auch die aktuelle Unterseite und generische Filter (z. B. Sortierung) bei',
        h1About:           'Über',
    ...
    it: {
        ...
        labelGameSwitcherFullContextEnabled: 'Mantieni pagina e filtri',
        hintGameSwitcherFullContextEnabled: 'Mantiene anche la sottopagina corrente e i filtri generici (es. ordinamento) al cambio di gioco',
